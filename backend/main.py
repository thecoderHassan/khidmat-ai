...
from app.routers import agents, aliases, health, transcribe  # Added by aqib for voice testing, can remove if any issues
...
def create_app() -> FastAPI:
    ...
    app.include_router(transcribe.router)  # Added by aqib for voice testing, can remove if any issue
